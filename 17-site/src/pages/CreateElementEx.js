...
const CreateElementEx = memo(() => {
    ...
    const onInsertBefore1Click = useCallback((e) => {
        ...
        //->기준 점이 nuill인 경우 appendChild와 동일하게 동작
    ...
    return (
        <div>
            ...
            <button tpye="button" style={css} onClick={onInsertBefore1Click}>insertBefore1</button>
            <button tpye="button" style={css} onClick={onInsertBefore2Click}>insertBefore2</button>
            <hr />
